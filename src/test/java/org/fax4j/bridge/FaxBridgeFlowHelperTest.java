...
public class FaxBridgeFlowHelperTest {
    ...
    public void submitFaxJobFullTest() throws Exception {
        ...
        String[] inputData = new String[] { "-priority", FaxJobPriority.LOW_PRIORITY.name(), "-target_address", "12345",
                "-target_name", "tname", "-sender_name", "sname", "-sender_fax_number", "sfax", "-sender_email",
                "smail", "-property:p1", "v1", "-property:p2", "v2", "-property:", "v3", "-file", file.getPath() };
