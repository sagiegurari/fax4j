...
public class MultiPartHTTPRequestParserTest {
    ...
    public void setUp() throws Exception {
        ...
        list.add(new ContentPart<byte[]>("test_file", IOHelper.convertStringToBinary("TEST_FILE_CONTENT", null),
                ContentPartType.BINARY));
        list.add(new ContentPart<String>("test_filename", "TEST_FILE_NAME", ContentPartType.STRING));
        list.add(new ContentPart<String>("test_priority", FaxJobPriority.HIGH_PRIORITY.toString(),
    ...
    public void getContentPartsAsMapValidDataTest() throws Exception {
        ...
        Assert.assertArrayEquals(IOHelper.convertStringToBinary("TEST_FILE_CONTENT", null),
                (byte[]) output.get(this.parser.fileContentParameter).getContent());
        Assert.assertEquals("TEST_FILE_NAME", output.get(this.parser.fileNameParameter).getContent());
        Assert.assertEquals(FaxJobPriority.HIGH_PRIORITY.toString(),
                output.get(this.parser.priorityParameter).getContent());
