...
public class SimpleHTTPRequestParserTest {
    ...
    public void setUp() throws Exception {
        ...
        this.httpRequest.setParametersText("bad=bad&file=TEST_FILE&" + "priority=" + FaxJobPriority.LOW_PRIORITY.name()
                + "&target_address=TEST_TARGET_ADDRESS" + "&target_name=TEST_TARGET_NAME"
                + "&sender_name=TEST_SENDER_NAME" + "&sender_fax_number=TEST_SENDER_FAX_NUMBER"
                + "&sender_email=TEST_SENDER_EMAIL" + "&property:p1=v1" + "&property:p2=v2" + "&property:p3_novalue="
                + "&property:=nokey" + "&bad2=bad2&keynovalue=&=valuenokey");
