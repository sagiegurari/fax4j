...
public class PhaxioFaxClientSpiTest {
    ...
    public void setUp() throws Exception {
        ...
        this.faxClientSpi = (PhaxioFaxClientSpi) TestUtil.createFaxClientSpi(PhaxioFaxClientSpi.class.getName(),
                configuration);
        this.converter = (MultiPartFaxJob2HTTPRequestConverter) ReflectionHelper
                .getField(HTTPFaxClientSpi.class, "faxJob2HTTPRequestConverter").get(this.faxClientSpi);
    }
    ...
    public void createFaxJob2HTTPRequestConverterTest() throws Exception {
        FaxJob2HTTPRequestConverter output = (FaxJob2HTTPRequestConverter) ReflectionHelper.invokeMethod(
                HTTPFaxClientSpi.class, this.faxClientSpi, "createFaxJob2HTTPRequestConverter", null, null);
    ...
    public void createHTTPResponseHandlerTest() throws Exception {
        HTTPResponseHandler output = (HTTPResponseHandler) ReflectionHelper.invokeMethod(HTTPFaxClientSpi.class,
                this.faxClientSpi, "createHTTPResponseHandler", null, null);
        Assert.assertEquals(JSONHTTPResponseHandler.class, output.getClass());
        Assert.assertEquals("faxId",
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output, "getPathToResponseData",
                        new Class[] { FaxActionType.class }, new Object[] { FaxActionType.SUBMIT_FAX_JOB }));
        Assert.assertEquals("success",
                ReflectionHelper.getField(AbstractMappingHTTPResponseHandler.class, "errorDetectionPath").get(output));
        Assert.assertEquals("false",
                ReflectionHelper.getField(AbstractMappingHTTPResponseHandler.class, "errorDetectionValue").get(output));
        Assert.assertEquals("message",
                ReflectionHelper.getField(AbstractMappingHTTPResponseHandler.class, "errorMessagePath").get(output));
        Assert.assertEquals("data;status",
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output, "getPathToResponseData",
                        new Class[] { FaxActionType.class }, new Object[] { FaxActionType.GET_FAX_JOB_STATUS }));
        Assert.assertEquals(FaxJobStatus.PENDING,
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output,
                        "getFaxJobStatusFromStatusString", new Class[] { String.class }, new Object[] { "queued" }));
        Assert.assertEquals(FaxJobStatus.PENDING,
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output,
                        "getFaxJobStatusFromStatusString", new Class[] { String.class },
                        new Object[] { "pendingbatch" }));
        Assert.assertEquals(FaxJobStatus.IN_PROGRESS,
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output,
                        "getFaxJobStatusFromStatusString", new Class[] { String.class },
                        new Object[] { "inprogress" }));
        Assert.assertEquals(FaxJobStatus.ERROR, ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class,
                output, "getFaxJobStatusFromStatusString", new Class[] { String.class }, new Object[] { "failure" }));
        Assert.assertEquals(FaxJobStatus.ERROR,
                ReflectionHelper.invokeMethod(AbstractMappingHTTPResponseHandler.class, output,
                        "getFaxJobStatusFromStatusString", new Class[] { String.class },
                        new Object[] { "partialsuccess" }));
    }
    ...
    public void initializeImplConfiguredValuesTest() throws Exception {
        Assert.assertEquals("filename",
                ReflectionHelper.getField(MultiPartFaxJob2HTTPRequestConverter.class, "submitFileContentParameter")
                        .get(this.converter));
        Assert.assertEquals("to",
                ReflectionHelper.getField(MultiPartFaxJob2HTTPRequestConverter.class, "submitTargetAddressParameter")
                        .get(this.converter));
        Assert.assertEquals("caller_id",
                ReflectionHelper.getField(MultiPartFaxJob2HTTPRequestConverter.class, "submitSenderFaxNumberParameter")
                        .get(this.converter));
        Assert.assertEquals("id", ReflectionHelper
                .getField(MultiPartFaxJob2HTTPRequestConverter.class, "cancelFaxJobIDParameter").get(this.converter));
        Assert.assertEquals("id",
                ReflectionHelper.getField(MultiPartFaxJob2HTTPRequestConverter.class, "getStatusFaxJobIDParameter")
                        .get(this.converter));
        Assert.assertFalse(
                ((Boolean) ReflectionHelper.getField(MultiPartFaxJob2HTTPRequestConverter.class, "addFileNamePart")
                        .get(this.converter)).booleanValue());
    }
    ...
    public void createHTTPRequestGetStatusTest() throws Exception {
        FaxJob faxJob = new FaxJobImpl();
        faxJob.setID("12345");
        HTTPRequest output = this.converter.createHTTPRequest(this.faxClientSpi, FaxActionType.GET_FAX_JOB_STATUS,
                faxJob);
