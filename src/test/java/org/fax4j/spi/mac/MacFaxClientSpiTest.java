...
public class MacFaxClientSpiTest {
    ...
    public void setUp() throws Exception {
        ...
        this.faxClientSpi = (MacFaxClientSpi) TestUtil.createFaxClientSpi(MacFaxClientSpi.class.getName(),
                configuration);
    }
    ...
    public void createSubmitFaxCommandTest() throws Exception {
        ...
        Assert.assertNotNull(output);
        Assert.assertEquals(
                this.command + " testp2 testp3 testp4 testp5=123123123 testp6=\"TARGET_NAME\" \"test_file\"", output);
    }
