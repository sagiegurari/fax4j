...
public class AbstractMailConnectionFactoryTest {
    ...
    public void setUp() throws Exception {
        ...
        MailFaxClientSpi faxClientSpi = (MailFaxClientSpi) TestUtil.createFaxClientSpi(MailFaxClientSpi.class.getName(),
                configuration);
    ...
    public void initializeValidTest() throws Exception {
        ...
        Assert.assertNotSame(Integer.valueOf(0),
                Integer.valueOf(this.connectionFactory.mailConnectionProperties.size()));
