...
public class HylaFaxClientSpiTest {
    ...
    public void setUp() {
        ...
        configuration.setProperty("org.fax4j.spi.hylafax.connection.factory.class.name",
                TestHylaFAXClientConnectionFactory.class.getName());
        ...
        this.faxClientSpi = (HylaFaxClientSpi) TestUtil.createFaxClientSpi(HylaFaxClientSpi.class.getName(),
                configuration);
    }
