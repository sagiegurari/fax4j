...
public class TemplateFaxJob2HTTPRequestConverterTest {
    ...
    public void setUp() throws Exception {
        ...
        this.configuration.setProperty("org.fax4j.spi.http.faxjob2request.converter.class.name",
        ...
        this.configuration.setProperty("org.fax4j.spi.http.url.parameters",
        ...
        file.deleteOnExit();
        this.configuration.setProperty("org.fax4j.spi.http.suspend.template.url",
        ...
        file.deleteOnExit();
        this.configuration.setProperty("org.fax4j.spi.http.get.status.template.url",
                file.toURI().toURL().toExternalForm());

        this.faxClientSpi = (HTTPFaxClientSpi) TestUtil.createFaxClientSpi(HTTPFaxClientSpi.class.getName(),
                this.configuration);
    ...
    public void createHTTPRequestTest() throws Exception {
        ...
        HTTPRequest output = this.converter.createHTTPRequest(this.faxClientSpi, FaxActionType.SUBMIT_FAX_JOB,
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_FAX_JOB_TEMPLATE_PROPERTY_KEY, faxJob);
