...
public class FaxJobImplTest {
    ...
    public void toStringTest() throws Exception {
        ...
        Assert.assertNotSame(Integer.valueOf(-1),
                Integer.valueOf(output.indexOf("Sender Fax Number: TEST_SENDER_FAX_NUMBER")));
        Assert.assertNotSame(Integer.valueOf(-1),
                Integer.valueOf(output.indexOf("Target Address: TEST_TARGET_ADDRESS")));
