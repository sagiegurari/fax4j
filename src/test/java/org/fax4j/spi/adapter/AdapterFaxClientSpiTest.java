...
public class AdapterFaxClientSpiTest {
    ...
    public void setUp() {
        ...
        this.faxClientSpi = (AdapterFaxClientSpi) TestUtil.createFaxClientSpi(AdapterFaxClientSpi.class.getName(),
                configuration);
        this.emptyFaxClientSpi = (EmptyFaxClientSpi) TestUtil.createFaxClientSpi(EmptyFaxClientSpi.class.getName(),
                null);
    }
    ...
    public void validateConditionPropertyExistsTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.PROPERTY_CONDITION.toString(), "p1");
    ...
    public void validateConditionPropertyNotExistsTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.PROPERTY_CONDITION.toString(), "p0");
    ...
    public void validateConditionPropertyOSValidTest() throws Exception {
        ...
        boolean output = this.faxClientSpi.validateCondition(FaxClientSpiConfigurationConstants.OS_CONDITION.toString(),
                osName);
        Assert.assertTrue(output);
    }
    ...
    public void validateConditionPropertyJavaClassValidTest() throws Exception {
        boolean output = this.faxClientSpi.validateCondition(
                FaxClientSpiConfigurationConstants.JAVA_CLASS_CONDITION.toString(), String.class.getName());
        Assert.assertTrue(output);
    }
    ...
    public void validateConditionPropertyJavaClassInvalidTest() throws Exception {
        boolean output = this.faxClientSpi.validateCondition(
                FaxClientSpiConfigurationConstants.JAVA_CLASS_CONDITION.toString(), "test.123.InvalidClass");
        Assert.assertFalse(output);
    }
    ...
    public void validateConditionPropertyNativeLibValidTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.NATIVE_LIB_CONDITION.toString(), "jawt");
        Assert.assertTrue(output);
    }
    ...
    public void validateConditionPropertyNativeLibInvalidTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.NATIVE_LIB_CONDITION.toString(), "InvalidLib");
        Assert.assertFalse(output);
    }
    ...
    public void validateConditionPropertyExecutableValidTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.EXECUTABLE_CONDITION.toString(), "/bin/echo");
        if (!output) {
            output = this.faxClientSpi
                    .validateCondition(FaxClientSpiConfigurationConstants.EXECUTABLE_CONDITION.toString(), "java.exe");
        }
        Assert.assertTrue(output);
    }
    ...
    public void validateConditionPropertyExecutableInvalidTest() throws Exception {
        boolean output = this.faxClientSpi.validateCondition(
                FaxClientSpiConfigurationConstants.EXECUTABLE_CONDITION.toString(), "InvalidExecutable");
        Assert.assertFalse(output);
    }
    ...
    public void validateConditionPropertyStablePropertyValidTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.STABLE_CONDITION.toString(), "empty");
        if (!output) {
            output = this.faxClientSpi
                    .validateCondition(FaxClientSpiConfigurationConstants.EXECUTABLE_CONDITION.toString(), "java.exe");
        }
    ...
    public void validateConditionPropertyStablePropertyInvalidTest() throws Exception {
        boolean output = this.faxClientSpi
                .validateCondition(FaxClientSpiConfigurationConstants.STABLE_CONDITION.toString(), "some_value");
        Assert.assertFalse(output);
    }
        ...
        while (iterator.hasNext()) {
            ...
            if (key.startsWith("org.fax4j.spi.type.map.")) {
                ...
                if ((!type.equals("test")) && (!type.equals("adapter"))) {
                    ...
                    Assert.assertNotSame("No value found for property: " + key, Integer.valueOf(0),
                            Integer.valueOf(value.length()));

                    // ensure type is on types string
                    Assert.assertNotSame("Type not found on types string: " + type, Integer.valueOf(-1),
                            Integer.valueOf(typeString.indexOf(type)));
                    ...
                    String conditionString = this.emptyFaxClientSpi
                            .getConfigurationValue("org.fax4j.spi.adapter.internal.spi.condition." + type);
    ...
    public void windowsConditionConfigurationTest() throws Exception {
        ...
        String condition = this.emptyFaxClientSpi
                .getConfigurationValue("org.fax4j.spi.adapter.internal.spi.condition.windows");
        ...
        AdapterFaxClientSpi spi = (AdapterFaxClientSpi) FaxClientSpiFactory.createFaxClientSpi("adapter",
                configuration);
    ...
    public void vbsConditionConfigurationTest() throws Exception {
        ...
        String condition = this.emptyFaxClientSpi
                .getConfigurationValue("org.fax4j.spi.adapter.internal.spi.condition.vbs");
        Assert.assertNotSame(Integer.valueOf(-1), Integer.valueOf(condition.indexOf("OS:windows")));
    ...
    public void linuxConditionConfigurationTest() throws Exception {
        ...
        String condition = this.emptyFaxClientSpi
                .getConfigurationValue("org.fax4j.spi.adapter.internal.spi.condition.linux");
    ...
    public void macConditionConfigurationTest() throws Exception {
        ...
        String condition = this.emptyFaxClientSpi
                .getConfigurationValue("org.fax4j.spi.adapter.internal.spi.condition.mac");
