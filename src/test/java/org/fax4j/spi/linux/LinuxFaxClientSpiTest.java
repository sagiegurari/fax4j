...
public class LinuxFaxClientSpiTest {
    ...
    public void setUp() throws Exception {
        ...
        configuration.setProperty("org.fax4j.spi.linux.output.validator",
                WindowsProcessOutputValidator.class.getName());
        this.faxClientSpi = (LinuxFaxClientSpi) TestUtil.createFaxClientSpi(LinuxFaxClientSpi.class.getName(),
                configuration);
    }
