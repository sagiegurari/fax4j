...
public class CommFaxClientSpiTest {
    ...
    public void setUp() {
        ...
        this.faxClientSpi = (CommFaxClientSpi) TestUtil.createFaxClientSpi(CommFaxClientSpi.class.getName(),
                this.configuration);
    }
    ...
    public void initializeImplNoConnectionFactoryClassNameTest() throws Exception {
        ...
        this.faxClientSpi = (CommFaxClientSpi) TestUtil.createFaxClientSpi(CommFaxClientSpi.class.getName(),
                this.configuration);
        Assert.assertEquals(RXTXCommPortConnectionFactory.class,
                this.faxClientSpi.createCommPortConnectionFactory().getClass());
    }
