...
public class AbstractCommPortConnectionFactoryTest {
    ...
    public void setUp() throws Exception {
        ...
        this.configuration.setProperty("org.fax4j.spi.comm.connection.factory.class.name",
                TestCommPortConnectionFactory.class.getName());
        ...
        CommFaxClientSpi faxClientSpi = (CommFaxClientSpi) TestUtil.createFaxClientSpi(CommFaxClientSpi.class.getName(),
                this.configuration);
    ...
    public void initializeNoTimeoutTest() throws Exception {
        ...
        CommFaxClientSpi faxClientSpi = (CommFaxClientSpi) TestUtil.createFaxClientSpi(CommFaxClientSpi.class.getName(),
                this.configuration);
        this.connectionFactory.initialize(faxClientSpi);
        Assert.assertEquals(Integer.valueOf(CommFaxClientSpi.TIMEOUT_DEFAULT_VALUE),
                Integer.valueOf(this.connectionFactory.getTimeOut()));
    }
