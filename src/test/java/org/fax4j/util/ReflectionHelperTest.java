...
public class ReflectionHelperTest {
    ...
    public void invokeMethodValidTest() throws Exception {
        Object output = ReflectionHelper.invokeMethod(String.class, "123", "substring",
                new Class[] { int.class, int.class }, new Object[] { Integer.valueOf(1), Integer.valueOf(2) });
    ...
    public void invokeMethodNoSuchMethodTest() throws Exception {
        ReflectionHelper.invokeMethod(String.class, "123", "not_found", new Class[] { int.class, int.class },
    ...
    public void invokeMethodErrorInMethodTest() throws Exception {
        ReflectionHelper.invokeMethod(String.class, null, "substring", new Class[] { int.class, int.class },
                new Object[] { Integer.valueOf(1), Integer.valueOf(2) });
    }
