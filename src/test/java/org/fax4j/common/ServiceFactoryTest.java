...
public class ServiceFactoryTest {
    ...
    public void createServiceEnumTest() throws Exception {
        Service output = ServiceFactory.createService(ServiceFactoryTestEnum.CLASS_NAME_KEY_TEST, null,
                this.configurationHolder, null);
        Assert.assertNotNull(output);
        Assert.assertEquals(EmptyHTTPResponseHandler.class, output.getClass());
    }
    ...
    public void createServiceUseDefaultTest() throws Exception {
        Service output = ServiceFactory.createService("CLASS_NAME_KEY_TEST123",
                EmptyHTTPResponseHandler.class.getName(), this.configurationHolder, null);
        Assert.assertNotNull(output);
        Assert.assertEquals(EmptyHTTPResponseHandler.class, output.getClass());
    }
}