...
public class FaxMonitorEventTest {
    ...
    public void getIDTest() throws Exception {
        FaxMonitorEvent event = new FaxMonitorEvent(FaxMonitorEventID.FAX_JOB_STATUS_CHANGE, new FaxJobImpl(),
                FaxJobStatus.ERROR);
    ...
    public void getFaxJobTest() throws Exception {
        ...
        FaxMonitorEvent event = new FaxMonitorEvent(FaxMonitorEventID.FAX_JOB_STATUS_CHANGE, faxJob,
                FaxJobStatus.ERROR);
