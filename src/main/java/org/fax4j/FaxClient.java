 ...
 * The fax client enables to perform activities such as sending/suspending fax jobs and so on.<br>
 * This is the class which will be used by external applications to invoke the actual fax related activites.<br>
 ...
 * <br>
 * Below table describes the configuration values relevant for this class, for SPI specific configuration, see the
 * relevant SPI class javadoc.<br>
 * <b>Configuration:</b>
 ...
 * <td>For each SPI type, there is a property that (with prefix: org.fax4j.spi.type.map. and type name for example:
 * org.fax4j.spi.type.map.adapter) which defines the SPI class name for the given SPI type.<br>
 * For example:<br>
 ...
 * <td>org.fax4j.spi.type.map.adapter=org.fax4j.spi.adapter.AdapterFaxClientSpi<br>
 ...
 * org.fax4j.spi.type.map.rfax=org.fax4j.spi.java4less.RFaxFaxClientSpi</td>
 * <td>NA</td>
 * <td>NA</td>
 * </tr>
 * <tr>
 * <td>org.fax4j.spi.default.type</td>
 * <td>In case the SPI type was not provided in the createFaxClientSpi method, the type will be taken from this property
 * value.</td>
 * <td>adapter</td>
 * <td>none</td>
 * <td>false</td>
 ...
 * This property can only be set in the internal fax4j.properties and the fax4j.properties on the classpath, providing
 * these values as part of the java.util.Properties input of the createFaxClientSpi will have no affect.</td>
 ...
 * This property can only be set in the internal fax4j.properties and the fax4j.properties on the classpath, providing
 * these values as part of the java.util.Properties input of the createFaxClientSpi will have no effect.</td>
 * <td>ERROR</td>
 * <td>ERROR</td>
 * <td>false</td>
 * </tr>
 ...
 * Since the fax client redirects the operations to the SPI (the engine) classes, creating a custom fax client is not
 * required.</td>
...
public class FaxClient implements FaxClientActions {
    ...
    /**
     * This function adds the fax monitor event listener to the internal fax event listeners data structure.<br>
    ...
    /**
     * This function removes all fax monitor event listeners from the internal fax event listeners data structure.<br>
     * <b>Not all SPIs support monitoring events.</b>
     */
