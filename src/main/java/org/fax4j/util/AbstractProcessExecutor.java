...
public abstract class AbstractProcessExecutor implements ProcessExecutor {
    ...
    public ProcessOutput executeProcess(ConfigurationHolder configurationHolder, String command)
        ...
        this.LOGGER.logDebug(new Object[] { "Invoked command: ", updatedCommand, " Exit Code: ",
                String.valueOf(exitCode), Logger.SYSTEM_EOL, "Output Text:", Logger.SYSTEM_EOL, outputText,
                Logger.SYSTEM_EOL, "Error Text:", Logger.SYSTEM_EOL, errorText }, null);
     ...
     *             If thread interrupted during waitFor for the process
     */
    protected abstract ProcessOutput executeProcessImpl(ConfigurationHolder configurationHolder, String command)
            throws IOException, InterruptedException;
}