...
public final class SpiUtil {
    ...
    /** The file template parameter */
    public static final String FILE_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.FILE_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The target address template parameter */
    public static final String TARGET_ADDRESS_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.TARGET_ADDRESS_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The target name template parameter */
    public static final String TARGET_NAME_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.TARGET_NAME_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The sender name template parameter */
    public static final String SENDER_NAME_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.SENDER_NAME_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The sender fax number template parameter */
    public static final String SENDER_FAX_NUMBER_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.SENDER_FAX_NUMBER_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The sender email template parameter */
    public static final String SENDER_EMAIL_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.SENDER_EMAIL_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
    /** The fax job ID template parameter */
    public static final String FAX_JOB_ID_TEMPLATE_PARAMETER_STRING = SpiUtil.TEMPLATE_PARAMETER_PREFIX
            + SpiUtil.SENDER_EMAIL_TEMPLATE_PARAMETER + SpiUtil.TEMPLATE_PARAMETER_SUFFIX;
     ...
     *            or just the name in case of false)
     * @return The formatted template
     */
    public static String formatTemplate(String template, FaxJob faxJob, TemplateParameterEncoder encoder,
            boolean getFileContent, boolean fullFilePath) {
        // get logger
        ...
        if (text != null) {
            ...
            text = SpiUtil.replaceTemplateParameter(text, SpiUtil.TARGET_ADDRESS_TEMPLATE_PARAMETER_STRING, value,
                    encoder);
            value = faxJob.getTargetName();
            text = SpiUtil.replaceTemplateParameter(text, SpiUtil.TARGET_NAME_TEMPLATE_PARAMETER_STRING, value,
                    encoder);
            value = faxJob.getSenderName();
            text = SpiUtil.replaceTemplateParameter(text, SpiUtil.SENDER_NAME_TEMPLATE_PARAMETER_STRING, value,
                    encoder);
            value = faxJob.getSenderFaxNumber();
            text = SpiUtil.replaceTemplateParameter(text, SpiUtil.SENDER_FAX_NUMBER_TEMPLATE_PARAMETER_STRING, value,
                    encoder);
            value = faxJob.getSenderEmail();
            text = SpiUtil.replaceTemplateParameter(text, SpiUtil.SENDER_EMAIL_TEMPLATE_PARAMETER_STRING, value,
                    encoder);
            value = faxJob.getID();
