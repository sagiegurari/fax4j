...
public abstract class AbstractConnectionFactory<T> implements ConnectionFactory<T> {
    ...
    public Connection<T> createConnection() {
        // log info
        this.LOGGER.logInfo(new Object[] { "Opening a new connection from factory type: ", this.getClass().getName() },
                null);
    ...
    public void releaseConnection(Connection<T> connection) {
        if (connection != null) {
            try {
                // log info
                this.LOGGER.logInfo(
                        new Object[] { "Closing connection using factory type: ", this.getClass().getName() }, null);
