...
/**
 * The vendor policy enables vendors to hook into the fax submitting flow, enabling to restrict access, bill customers
 * and so on, before/after the fax is submitted.<br>
...
public interface VendorPolicy {
     ...
     * The policy may charge a customer for the service, or validate the user has permissions to invoke the action and
     * so on.<br>
     ...
     */
    boolean invokePolicyForResponse(Object requestDataHolder, FaxJob faxJob);
}
