...
public class MultiPartHTTPRequestParser extends AbstractRequestParser<HTTPRequest> implements HTTPRequestParser {
    ...
    public enum HTTPRequestParserConfigurationConstants {
        ...
        FILE_CONTENT_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.file.content.parameter"),
        ...
        TARGET_ADDRESS_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.target.address.parameter"),
        /** The target name parameter name property key */
        TARGET_NAME_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.target.name.parameter"),
        /** The sender name parameter name property key */
        SENDER_NAME_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.sender.name.parameter"),
        /** The sender fax number parameter name property key */
        SENDER_FAX_NUMBER_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.sender.fax.number.parameter"),
        /** The sender email parameter name property key */
        SENDER_EMAIL_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.bridge.http.request.parser.multi.part.sender.email.parameter");
    ...
    protected void initializeImpl(Map<String, String> configuration) {
        ...
        this.fileContentParameter = configurationHolder.getConfigurationValue(
                HTTPRequestParserConfigurationConstants.FILE_CONTENT_PARAMETER_NAME_PROPERTY_KEY);
        if (this.fileContentParameter == null) {
            this.fileContentParameter = "file";
        }
        this.fileNameParameter = configurationHolder
                .getConfigurationValue(HTTPRequestParserConfigurationConstants.FILE_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.fileNameParameter == null) {
            this.fileNameParameter = "filename";
        }
        this.priorityParameter = configurationHolder
                .getConfigurationValue(HTTPRequestParserConfigurationConstants.PRIORITY_PARAMETER_NAME_PROPERTY_KEY);
        if (this.priorityParameter == null) {
            this.priorityParameter = "priority";
        }
        this.targetAddressParameter = configurationHolder.getConfigurationValue(
                HTTPRequestParserConfigurationConstants.TARGET_ADDRESS_PARAMETER_NAME_PROPERTY_KEY);
        if (this.targetAddressParameter == null) {
            this.targetAddressParameter = "targetaddress";
        }
        this.targetNameParameter = configurationHolder
                .getConfigurationValue(HTTPRequestParserConfigurationConstants.TARGET_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.targetNameParameter == null) {
            this.targetNameParameter = "targetname";
        }
        this.senderNameParameter = configurationHolder
                .getConfigurationValue(HTTPRequestParserConfigurationConstants.SENDER_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.senderNameParameter == null) {
            this.senderNameParameter = "sendername";
        }
        this.senderFaxNumberParameter = configurationHolder.getConfigurationValue(
                HTTPRequestParserConfigurationConstants.SENDER_FAX_NUMBER_PARAMETER_NAME_PROPERTY_KEY);
        if (this.senderFaxNumberParameter == null) {
            this.senderFaxNumberParameter = "senderfaxnumber";
        }
        this.senderEMailParameter = configurationHolder.getConfigurationValue(
                HTTPRequestParserConfigurationConstants.SENDER_EMAIL_PARAMETER_NAME_PROPERTY_KEY);
            ...
            if (content != null) {
                ...
                case BINARY:
                    ...
                    try {
                        ...
                        throw new FaxException("Unable to convert binary data to string for parameter: " + parameter,
                                exception);
                    }
                    break;
                default:
