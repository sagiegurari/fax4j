...
public class RFaxFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    public enum FaxJobExtendedPropertyConstants {
        /**
         * The document data type (TEXT, PDF) fax job input. If this property is not defined in the fax job, the default
         * is text.
         */
        ...
        /**
         * The image type (constant values from BufferedImage). If this property is not defined in the fax job, the
         * default is BufferedImage.TYPE_INT_RGB
         */
    ...
    protected void initializeImpl() {
        ...
        if (this.portName == null) {
            throw new FaxException("Port name not defined in fax4j.properties. Property: "
                    + FaxClientSpiConfigurationConstants.PORT_NAME_PROPERTY_KEY);
        }

        // get fax class
        this.faxClass = Integer
                .parseInt(this.getConfigurationValue(FaxClientSpiConfigurationConstants.FAX_CLASS_PROPERTY_KEY));
    }
    ...
    protected void submitFaxJobViaFaxModem(FaxJob faxJob) throws Exception {
        // get type
        String type = faxJob.getProperty(FaxJobExtendedPropertyConstants.DATA_TYPE_FAX_JOB_PROPERTY_KEY.toString(),
                "TEXT");

        // get common values
        int width = Integer.parseInt(
                faxJob.getProperty(FaxJobExtendedPropertyConstants.WIDTH_FAX_JOB_PROPERTY_KEY.toString(), null));
        int height = Integer.parseInt(
                faxJob.getProperty(FaxJobExtendedPropertyConstants.HEIGHT_FAX_JOB_PROPERTY_KEY.toString(), null));
        int imageType = Integer
                .parseInt(faxJob.getProperty(FaxJobExtendedPropertyConstants.IMAGE_TYPE_FAX_JOB_PROPERTY_KEY.toString(),
                        String.valueOf(BufferedImage.TYPE_INT_RGB)));
        ...
        if (type.equalsIgnoreCase("PDF")) {
            ...
            ReflectionHelper.invokeMethod(classDefinition, faxProducer, "setPDFFile", new Class[] { String.class },
                    new Object[] { faxJob.getFilePath() });
        ...
        ReflectionHelper.invokeMethod(faxModemClassDefinition, faxModem, "setPortName", new Class[] { String.class },
        ...
        ReflectionHelper.invokeMethod(faxModemClassDefinition, faxModem, "open",
                new Class[] { faxProducerClassDefinition }, new Object[] { faxProducer });
        boolean faxSent = ((Boolean) ReflectionHelper.invokeMethod(faxModemClassDefinition, faxModem, "sendFax",
                new Class[] { String.class }, new Object[] { faxJob.getTargetAddress() })).booleanValue();
