 ...
 * @since 0.34
 */
public abstract class AbstractCommPortConnectionFactory extends AbstractFax4JConnectionFactory<CommPortAdapter>
    ...
    protected void initializeImpl() {
        // get port name
        this.portName = this.factoryConfigurationHolder
                .getConfigurationValue(FaxClientSpiConfigurationConstants.PORT_NAME_PROPERTY_KEY);
