...
public class CommFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    protected void initializeImpl() {
        ...
        this.commConnectionFactoryClassName = this
        ...
        this.faxModemClassName = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.FAX_MODEM_CLASS_NAME_PROPERTY_KEY);
        if (this.faxModemClassName == null) {
            throw new FaxException("Fax modem class name not defined in fax4j.properties. Property: "
                    + FaxClientSpiConfigurationConstants.FAX_MODEM_CLASS_NAME_PROPERTY_KEY);
        }
    ...
    protected final CommPortConnectionFactory createCommPortConnectionFactory() {
        // create new instance
        CommPortConnectionFactory factory = (CommPortConnectionFactory) ReflectionHelper
                .createInstance(this.commConnectionFactoryClassName);
