 ...
 * The HTTP URL parameters is the URL part after the ?, for example
 * http://www.mydomain.com/myresource?<b>param1=value1</b>.<br>
 ...
 * All template parameters are defined as ${templatename} variables, for example:
 * http://www.mydomain.com/myresource?faxnum=<b>${target.address}</b><br>
 * <br>
 ...
 * </table>
 * <br>
 * In case there is no template defined for a certain fax action, this class will return null. <br>
...
public class TemplateFaxJob2HTTPRequestConverter extends AbstractFaxJob2HTTPRequestConverter {
     ...
     * @return The HTTP request to send
     */
    protected HTTPRequest createHTTPRequest(HTTPFaxClientSpi faxClientSpi, FaxActionType faxActionType,
