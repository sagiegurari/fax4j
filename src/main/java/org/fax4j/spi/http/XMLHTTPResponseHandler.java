 ...
 * This class only supports extracting the fax job ID and fax job status from the XML response object, or in case of
 ...
 * org.fax4j.spi.http.xml.error.detection.path will be used instead.</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
...
public class XMLHTTPResponseHandler extends AbstractMappingHTTPResponseHandler<Document> {
    ...
    protected void populateFaxActionType2ReponseDataPathMappings() {
        ...
        Enum<?>[] configurationKeys = new Enum<?>[] {
                XMLHTTPResponseHandlerConfigurationConstants.SUBMIT_XML_OUTPUT_PROPERTY_KEY,
    ...
    protected void populateStatusString2FaxStatusMappings() {
        ...
        FaxJobStatus[] faxJobStatuses = new FaxJobStatus[] { FaxJobStatus.PENDING, FaxJobStatus.IN_PROGRESS,
                FaxJobStatus.ERROR };
        Enum<?>[] configurationKeys = new Enum<?>[] {
                XMLHTTPResponseHandlerConfigurationConstants.PENDING_STATUS_MAPPING_PROPERTY_KEY,
