 ...
 * <td>The fax job to HTTP request converter class name used to convert the fax job data into the relevant HTTP
 * request.</td>
...
public class HTTPFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    protected void initializeImpl() {
        String value = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.HTTP_CLIENT_CLASS_NAME_PROPERTY_KEY);
        if (value == null) {
    ...
    protected FaxJob2HTTPRequestConverter createFaxJob2HTTPRequestConverter() {
        ...
        // create converter
        FaxJob2HTTPRequestConverter converter = (FaxJob2HTTPRequestConverter) ServiceFactory.createService(
                FaxClientSpiConfigurationConstants.FAX_JOB2HTTP_REQUEST_CONVERTER_CLASS_NAME_PROPERTY_KEY,
                MultiPartFaxJob2HTTPRequestConverter.class.getName(), this, propertyPart);
    ...
    protected HTTPResponseHandler createHTTPResponseHandler() {
        ...
        // create handler
        HTTPResponseHandler handler = (HTTPResponseHandler) ServiceFactory.createService(
                FaxClientSpiConfigurationConstants.HTTP_RESPONSE_HANDLER_CLASS_NAME_PROPERTY_KEY,
                JSONHTTPResponseHandler.class.getName(), this, propertyPart);
