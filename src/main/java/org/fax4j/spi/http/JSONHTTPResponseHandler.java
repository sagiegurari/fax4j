 ...
 * This class only supports extracting the fax job ID and fax job status from the JSON response object, or in case of
 * errors, extract the error message. <br>
 ...
 * <td>The mapping between the output fax status string value to the fax4j FaxJobStatus.PENDING enum value (format is:
 * value1;value2;value3).</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
 ...
 * <td>The mapping between the output fax status string value to the fax4j FaxJobStatus.IN_PROGRESS enum value (format
 * is: value1;value2;value3).</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
 ...
 * <td>The mapping between the output fax status string value to the fax4j FaxJobStatus.ERROR enum value (format is:
 * value1;value2;value3).</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 ...
 * <td>If detection path and value are defined, the value in the path is searched within the configured value. If value
 * is not defined, all values are considered as errors.</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
 ...
 * <td>The path to the error message if errors are detected. If this property is not defined, the value found at
 * org.fax4j.spi.http.json.error.detection.path will be used instead.</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
...
public class JSONHTTPResponseHandler extends AbstractMappingHTTPResponseHandler<JSONObject> {
    ...
    protected void populateFaxActionType2ReponseDataPathMappings() {
        ...
        FaxActionType[] faxActionTypes = new FaxActionType[] { FaxActionType.SUBMIT_FAX_JOB,
                FaxActionType.SUSPEND_FAX_JOB, FaxActionType.RESUME_FAX_JOB, FaxActionType.CANCEL_FAX_JOB,
                FaxActionType.GET_FAX_JOB_STATUS };
        Enum<?>[] configurationKeys = new Enum<?>[] {
                JSONHTTPResponseHandlerConfigurationConstants.SUBMIT_JSON_OUTPUT_PROPERTY_KEY,
    ...
    protected void populateStatusString2FaxStatusMappings() {
        // populate map
        FaxJobStatus[] faxJobStatuses = new FaxJobStatus[] { FaxJobStatus.PENDING, FaxJobStatus.IN_PROGRESS,
                FaxJobStatus.ERROR };
        Enum<?>[] configurationKeys = new Enum<?>[] {
                JSONHTTPResponseHandlerConfigurationConstants.PENDING_STATUS_MAPPING_PROPERTY_KEY,
