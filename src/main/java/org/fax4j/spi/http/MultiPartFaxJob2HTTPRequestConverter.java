 ...
 * The parameter names are set in the fax4j configuration and their values are extracted from the fax job. <br>
 ...
 * <td>The additional parameter to submit where X is the parameter key and the property value is the parameter
 * value,<br>
 * For example org.fax4j.spi.http.multi.part.parameter.key.my.property=my_value<br>
 * This converter will also send parameter my.property with value my_value</td>
 * <td>none</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
...
public class MultiPartFaxJob2HTTPRequestConverter extends AbstractFaxJob2HTTPRequestConverter {
    ...
    public enum FaxJob2HTTPRequestConverterConfigurationConstants {
        ...
        SUBMIT_ACTION_FILE_CONTENT_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.file.content.parameter"),
        ...
        SUBMIT_ACTION_TARGET_ADDRESS_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.target.address.parameter"),
        /** The target name parameter name for the submit action property key */
        SUBMIT_ACTION_TARGET_NAME_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.target.name.parameter"),
        /** The sender name parameter name for the submit action property key */
        SUBMIT_ACTION_SENDER_NAME_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.sender.name.parameter"),
        /** The sender fax number parameter name for the submit action property key */
        SUBMIT_ACTION_SENDER_FAX_NUMBER_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.sender.fax.number.parameter"),
        /** The sender email parameter name for the submit action property key */
        SUBMIT_ACTION_SENDER_EMAIL_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.submit.sender.email.parameter"),
        /** The fax job ID parameter name for the suspend action property key */
        SUSPEND_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.suspend.fax.job.id.parameter"),
        /** The fax job ID parameter name for the resume action property key */
        RESUME_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.resume.fax.job.id.parameter"),
        /** The fax job ID parameter name for the cancel action property key */
        CANCEL_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.cancel.fax.job.id.parameter"),
        /** The fax job ID parameter name for the get fax job status action property key */
        GET_FAX_JOB_STATUS_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY(
                "org.fax4j.spi.{0}.multi.part.get.status.fax.job.id.parameter"),
    ...
    protected void initializeImpl() {
        this.submitFileContentParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_FILE_CONTENT_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitFileContentParameter == null) {
            this.submitFileContentParameter = "file";
        }
        this.submitFileNameParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_FILE_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitFileNameParameter == null) {
            this.submitFileNameParameter = "filename";
        }
        this.submitTargetAddressParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_TARGET_ADDRESS_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitTargetAddressParameter == null) {
            this.submitTargetAddressParameter = "targetaddress";
        }
        this.submitTargetNameParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_TARGET_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitTargetNameParameter == null) {
            this.submitTargetNameParameter = "targetname";
        }
        this.submitSenderNameParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_SENDER_NAME_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitSenderNameParameter == null) {
            this.submitSenderNameParameter = "sendername";
        }
        this.submitSenderFaxNumberParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_SENDER_FAX_NUMBER_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitSenderFaxNumberParameter == null) {
            this.submitSenderFaxNumberParameter = "senderfaxnumber";
        }
        this.submitSenderEMailParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUBMIT_ACTION_SENDER_EMAIL_PARAMETER_NAME_PROPERTY_KEY);
        if (this.submitSenderEMailParameter == null) {
            this.submitSenderEMailParameter = "senderemail";
        }
        this.suspendFaxJobIDParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.SUSPEND_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY);
        if (this.suspendFaxJobIDParameter == null) {
            this.suspendFaxJobIDParameter = "faxjobid";
        }
        this.resumeFaxJobIDParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.RESUME_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY);
        if (this.resumeFaxJobIDParameter == null) {
            this.resumeFaxJobIDParameter = "faxjobid";
        }
        this.cancelFaxJobIDParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.CANCEL_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY);
        if (this.cancelFaxJobIDParameter == null) {
            this.cancelFaxJobIDParameter = "faxjobid";
        }
        this.getStatusFaxJobIDParameter = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.GET_FAX_JOB_STATUS_ACTION_FAX_JOB_ID_PARAMETER_NAME_PROPERTY_KEY);
        if (this.getStatusFaxJobIDParameter == null) {
            this.getStatusFaxJobIDParameter = "faxjobid";
        }
        this.addFileNamePart = true;
        String value = this.getConfigurationValue(
                FaxJob2HTTPRequestConverterConfigurationConstants.ADD_FILE_NAME_AS_PART_PROPERTY_KEY);
        if (value != null) {
    ...
    protected Map<String, String> initializeAdditionalParameters() {
        ...
        // get prefix
        String prefix = FaxJob2HTTPRequestConverterConfigurationConstants.ADDITIONAL_PARAMETER_PROPERTY_KEY_PREFIX
                .toString();
     ...
     *            The content list with all the created parts
     */
    protected void addAdditionalContentParts(HTTPFaxClientSpi faxClientSpi, FaxActionType faxActionType, FaxJob faxJob,
            List<ContentPart<?>> contentList) {
