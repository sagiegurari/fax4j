...
/**
 * This class provides partial implementation of the HTTP response handler interface. <br>
...
public abstract class AbstractHTTPResponseHandler extends AbstractService implements HTTPResponseHandler {
    ...
    protected void initializeImpl() {
        // get encoding
        this.responseDataEncoding = this
                .getConfigurationValue(AbstractHTTPResponseHandler.RESPONSE_DATA_ENCODING_PROPERTY_KEY);
