...
/**
 * This class provides the logging implementation of the fax client SPI interceptor which enables to log all fax client
 * SPI method invocations. <br>
...
public class LogFaxClientSpiInterceptor extends AbstractFaxClientSpiInterceptor {
     ...
     */
    protected void logEvent(FaxClientSpiProxyEventType eventType, Method method, Object[] arguments, Object output,
            Throwable throwable) {
        // init log data
        int amount = 3;
