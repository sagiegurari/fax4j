 ...
 * and after the fax client SPI method invocations.<br>
...
public abstract class AbstractFaxClientSpiProxy implements FaxClientSpiProxy {
     ...
     */
    protected abstract void invokeInterceptors(FaxClientSpiProxyEventType eventType, Method method, Object[] arguments,
