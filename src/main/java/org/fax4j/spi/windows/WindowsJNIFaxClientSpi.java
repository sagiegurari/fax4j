...
public class WindowsJNIFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    protected void submitFaxJobImpl(FaxJob faxJob) {
        ...
        String documentName = faxJob.getProperty(
                WindowsFaxClientSpi.FaxJobExtendedPropertyConstants.DOCUMENT_NAME_PROPERTY_KEY.toString(), "");
    ...
    protected FaxJobStatus getFaxJobStatusImpl(FaxJob faxJob) {
        ...
        FaxJobStatus faxJobStatus = WindowsFaxClientSpiHelper
                .getFaxJobStatusFromWindowsFaxJobStatusString(faxJobStatusStr);
     ...
     */
    private int winSubmitFaxJob(String serverName, String targetAddress, String targetName, String senderName,
        ...
        synchronized (WindowsFaxClientSpiHelper.NATIVE_LOCK) {
            ...
            // invoke native
            faxJobID = WindowsJNIFaxClientSpi.submitFaxJobNative(serverName, targetAddress, targetName, senderName,
     ...
     * @return The fax job ID (null in case of an error)
     */
    private static native int submitFaxJobNative(String serverName, String targetAddress, String targetName,
            String senderName, String fileName, String documentName);
