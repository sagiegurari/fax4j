...
/**
 * This class implements the windows process output handler which is used to update the fax job based on the process
 * output information.
 * 
...
public class WindowsProcessOutputHandler implements ProcessOutputHandler {
     ...
     *            The fax action type
     */
    public void updateFaxJob(FaxClientSpi faxClientSpi, FaxJob faxJob, ProcessOutput processOutput,
            FaxActionType faxActionType) {
        // get output
        String output = WindowsFaxClientSpiHelper.getOutputPart(processOutput,
                Fax4jExeConstants.FAX_JOB_ID_OUTPUT_PREFIX.toString());
    ...
    public FaxJobStatus getFaxJobStatus(FaxClientSpi faxClientSpi, ProcessOutput processOutput) {
        // get output
        String output = WindowsFaxClientSpiHelper.getOutputPart(processOutput,
                Fax4jExeConstants.FAX_JOB_STATUS_OUTPUT_PREFIX.toString());
