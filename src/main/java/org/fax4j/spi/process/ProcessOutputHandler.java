...
/**
 * This interface defines the process output handler which is used to update the fax job based on the process output
 * information.
 *
...
public interface ProcessOutputHandler {
     ...
     *            The fax action type
     */
    void updateFaxJob(FaxClientSpi faxClientSpi, FaxJob faxJob, ProcessOutput processOutput,
     ...
     */
    FaxJobStatus getFaxJobStatus(FaxClientSpi faxClientSpi, ProcessOutput processOutput);
}
