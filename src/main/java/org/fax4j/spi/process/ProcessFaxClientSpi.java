 ...
 * <b>${target.address}</b> -file <b>${file}</b><br>
 * <br>
...
public class ProcessFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    protected void initializeImpl() {
        ...
        this.windowsCommandPrefix = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.WINDOWS_PREFIX_PROPERTY_KEY);
    ...
    protected ProcessOutputValidator createProcessOutputValidator() {
        ...
        String className = this.getConfigurationValue(
                FaxClientSpiConfigurationConstants.PROCESS_OUTPUT_VALIDATOR_PRE_FORMAT_PROPERTY_KEY);
    ...
    protected ProcessOutputHandler createProcessOutputHandler() {
        ...
        String className = this.getConfigurationValue(
                FaxClientSpiConfigurationConstants.PROCESS_OUTPUT_HANDLER_PRE_FORMAT_PROPERTY_KEY);
    ...
    protected String createSubmitFaxJobProcessCommand(FaxJob faxJob) {
        return this.createProcessCommand(
                FaxClientSpiConfigurationConstants.SUBMIT_FAX_JOB_TEMPLATE_PRE_FORMAT_PROPERTY_KEY, faxJob);
    }
    ...
    protected String createSuspendFaxJobProcessCommand(FaxJob faxJob) {
        return this.createProcessCommand(
                FaxClientSpiConfigurationConstants.SUSPEND_FAX_JOB_TEMPLATE_PRE_FORMAT_PROPERTY_KEY, faxJob);
    }
    ...
    protected String createResumeFaxJobProcessCommand(FaxJob faxJob) {
        return this.createProcessCommand(
                FaxClientSpiConfigurationConstants.RESUME_FAX_JOB_TEMPLATE_PRE_FORMAT_PROPERTY_KEY, faxJob);
    }
    ...
    protected String createCancelFaxJobProcessCommand(FaxJob faxJob) {
        return this.createProcessCommand(
                FaxClientSpiConfigurationConstants.CANCEL_FAX_JOB_TEMPLATE_PRE_FORMAT_PROPERTY_KEY, faxJob);
    }
    ...
    protected String createGetStatusFaxJobProcessCommand(FaxJob faxJob) {
        return this.createProcessCommand(
                FaxClientSpiConfigurationConstants.GET_STATUS_FAX_JOB_TEMPLATE_PRE_FORMAT_PROPERTY_KEY, faxJob);
    }
}
