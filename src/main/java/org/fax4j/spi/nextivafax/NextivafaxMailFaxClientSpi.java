 ...
 * invocations or to create a new connection for each fax operation invocation.<br>
 ...
 * @since 0.41.6
 */
public class NextivafaxMailFaxClientSpi extends MailFaxClientSpi {
    /**
    ...
    public enum FaxClientSpiConfigurationConstants {
        ...
        MAIL_ADDRESS_TEMPLATE_VALUE("{0}@nextivafax.com"),
     ...
     */
    public NextivafaxMailFaxClientSpi() {
        super();
    }
