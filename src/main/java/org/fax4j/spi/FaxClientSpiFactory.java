...
/**
 * This is the fax client SPI factory which is used to create new instances of the fax client SPI.<br>
 * <br>
 ...
 * Each type must have a matching org.fax4j.proxy.interceptor.type.xxx property.</td>
 * <td>log</td>
 * <td>none</td>
 * <td>false</td>
 * </tr>
...
public final class FaxClientSpiFactory {
    ...
    private static FaxClientSpi createFaxClientSpiImpl(String type, Properties configuration, boolean childSPI) {
        ...
        if (!childSPI) {
            ...
            if (enableProxy) {
                ...
                faxClientSpiWrapper = (FaxClientSpi) Proxy.newProxyInstance(classLoader,
                        new Class[] { FaxClientSpi.class }, faxClientSpiProxy);
            }
        }
     ...
     * The configuration of the fax client SPI is made up of 3 layers. The lowest layer is the internal fax4j.properties
     * file located in the fax4j jar. This configuration file contains the initial default configuration. The next layer
                ...
                if ((type != null) && (type.length() > 0)) {
                    ...
                    if (className == null) {
                        throw new FaxException(
                                "Class name not defined by property: " + propertyKey + " for SPI interceptor.");
                    }
