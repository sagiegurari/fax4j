 ...
 * The executable used to invoke the VBS is defaulted to cscript. It is possible to set a different executable by
 * setting the <b>org.fax4j.spi.vbs.exe.path property</b>.<br>
 * By default the windows 2000 vbs API will be used on all platforms.<br>
 * In order for other platforms (other then windows 2000) to invoke the windows XP API, the
 * <b>org.fax4j.spi.vbs.always.use.win2000.api</b> property must be set to false.<br>
 * <br>
 ...
 * In order for other platforms (other then windows 2000) to invoke the windows XP API, this property must be set to
 * false.</td>
 * <td>true</td>
 * <td>true</td>
 * <td>false</td>
...
public class VBSFaxClientSpi extends AbstractFax4JClientSpi {
    ...
    private static final String[] VSB_SCRIPT_NAMES = new String[] { VBSFaxClientSpi.VBS_SCRIPT,
            ...
            VBSFaxClientSpi.VBS_WIN_XP_GET_FAX_JOB_STATUS_SCRIPT,
            VBSFaxClientSpi.VBS_WIN_2K_GET_FAX_JOB_STATUS_SCRIPT };
    ...
    protected void initializeImpl() {
        ...
        String valueStr = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.VBS_ALWAYS_USE_WIN2K_API_PROPERTY_KEY);
        if (valueStr == null) {
    ...
    protected Object[] setupSubmitFaxJobInput(FaxJob faxJob) {
        ...
        inputList.add(file);
        String documentName = faxJob
                .getProperty(FaxJobExtendedPropertyConstants.DOCUMENT_NAME_FAX_JOB_PROPERTY_KEY.toString(), null);
