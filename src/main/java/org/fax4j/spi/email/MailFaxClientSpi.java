 ...
 * email messages and fax messages.<br>
 ...
 * In order to provide the target fax number as part of the email address you must specify {0} in the template.<br>
 * For example: org.fax4j.spi.mail.address.template={0}@myprovider.com</td>
 * <td>none</td>
 * <td>none</td>
 * <td>true</td>
 * </tr>
 ...
 * In order to provide the target fax number as part of the email subject line you must specify {0} in the template.<br>
 * For example: org.fax4j.spi.mail.subject.template=fax:{0}</td>
 * <td>none</td>
 * <td>none</td>
 * <td>true</td>
 * </tr>
...
public class MailFaxClientSpi extends AbstractMailFaxClientSpi {
    ...
    protected void initializeImpl() {
        ...
        if (this.mailAddressTemplate == null) {
            throw new FaxException("Mail address template not defined in fax4j.properties. Property: "
        ...
        if (this.mailSubjectTemplate == null) {
            throw new FaxException("Mail subject template not defined in fax4j.properties. Property: "
    ...
    protected void initializeMailTemplates() {
        ...
        this.mailAddressTemplate = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.MAIL_ADDRESS_TEMPLATE_PROPERTY_KEY);

        // mail subject template
        this.mailSubjectTemplate = this
                .getConfigurationValue(FaxClientSpiConfigurationConstants.MAIL_SUBJECT_TEMPLATE_PROPERTY_KEY);
    }
