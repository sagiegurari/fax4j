...
/**
 * This class provides basic implementation of the fax client SPI proxy which enables to invoke interceptors before and
 * after the fax client SPI method invocations.<br>
 * With this proxy, it is possible to intercept all calls to the fax client SPIs and perform custom logic such as
 * logging. <br>
...
public class FaxClientSpiProxyImpl extends AbstractFaxClientSpiProxy {
     ...
     *            The throwable while invoking the method
     */
    protected void invokeInterceptorsImpl(FaxClientSpiProxyEventType eventType, Method method, Object[] arguments,
            Object output, Throwable throwable) {
        // get interceptors
