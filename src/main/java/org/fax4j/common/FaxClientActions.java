...
public interface FaxClientActions extends ProviderImplementation {
     ...
     */
    void addFaxClientActionEventListener(FaxClientActionEventListener listener);
     ...
     *            The fax client action event listener
     */
    void removeFaxClientActionEventListener(FaxClientActionEventListener listener);
     ...
     *            The fax monitor event listener
     */
    void removeFaxMonitorEventListener(FaxMonitorEventListener listener);
