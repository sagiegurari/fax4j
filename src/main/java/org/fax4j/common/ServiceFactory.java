...
public final class ServiceFactory {
     ...
     */
    public static Service createService(Enum<?> classNameKey, String defaultClassName,
            ConfigurationHolder configurationHolder, String propertyPart) {
        // validate input
        ...
        // create service
        Service service = ServiceFactory.createService(classNameKeyString, defaultClassName, configurationHolder,
                propertyPart);
     ...
     * @return The initialized service object
     */
    public static Service createService(String classNameKey, String defaultClassName,
            ConfigurationHolder configurationHolder, String propertyPart) {
        // validate input
